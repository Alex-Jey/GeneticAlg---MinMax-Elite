...
namespace Lab5___GeneticAlg
{
    ...
    class ProcSchedule
    {
        ...
        int SizeSchedule { get; set; }
        int ProcCount { get; set; }
        int Start { get; set; }
        int End { get; set; }

        int PopulationSize { get; set; }
        int MaxIdentyGeneration { get; set; }
        int ChanceCross { get; set; }
        int ChanceMutation { get; set; }
        bool EliteMod { get; set; }
        ...
        //    Console.WriteLine($"Кол-во процессоров P(N):  ");
        //    ProcCount = Convert.ToInt16(Console.ReadLine());

         
        //    Console.WriteLine($"Кол-во задач T(M)): ");
        ...
        //    Console.WriteLine($"Параметрв останова: ");
        //    MaxIdentyGeneration = Convert.ToInt16(Console.ReadLine()); ;

        //    Console.WriteLine($"Вероятность оператора кроссовера[0-100]% P(cross): ");
        //    ChanceCross = Convert.ToInt16(Console.ReadLine());


        //    Console.WriteLine($"Вероятность оператора мутации[0-100]% P(mut): ");
        ...
        //    {
        //        TranspList.Add(new List<int>());
        //        for (var j=0; j<Schedule[i].Count; j++)
        //        {
        ...
        //    {
        //        ElitePerson.Add((TranspList[i].IndexOf(TranspList[i].Min()) * 2+1) * (256/ProcCount/2));
        //    }
        ...
        public List<int> FreeLoad(List<List<int>> Lst)
        {
            ...
            Console.WriteLine("Загруженность процессоров:");
    ...
    {
       public static int ChangeEliteCounter = 0;
    }
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            ProcSchedule P = new ProcSchedule(4,10,2,10,5,90,90,5,false);
            ...
            Console.WriteLine($"Смена элитарной особи произошла: {Counter.ChangeEliteCounter}");
